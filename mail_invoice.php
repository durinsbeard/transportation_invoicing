...
<center>
		<fieldset id="button_field_set" class="button_field_set">
			...
			<A HREF="mailto:?Subject=SRC Logistics Invoice&Body=Below is your invoice information. Please review.%20%0ATotal%20Line%20Items:%20<?echo $total_line_items;?>%0A%0A
					Total Amount:%20<?echo "$".$totals["total"];?>%0A%0A
					Total Weight:%20<?echo $totals["weight"]."LBS";?>%0A%0A"><img height="40"width="40" src="images/1438012034_mail.png"></A>	
			<input style="float:right"id="cancel" name="cancel" id="cancel" type="submit" value="CANCEL" class="wide" style="margin-top:10px;"/>
			<!--<input type="text" id="invoice_line_items" name="invoice_line_items" value="<?echo base64_encode(serialize($invoice_items))?>">-->
		</fieldset>
</center>
</form>
</body>
