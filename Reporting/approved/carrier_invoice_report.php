<?
	...
	$sql = "SELECT line_item_id, 
			 ...
			 WHERE thedata.weight BETWEEN mm.min_weight AND mm.max_weight 
		...
		?>
		<center><h5><font style="color:green;">Approved</font> Shipments: <?echo $foundCarrierName['carrier_name'].", ".$invoice;?></h5></center>
