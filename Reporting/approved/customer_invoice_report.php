<?
    	...
    	$sql="SELECT line_item_id,
		 ...
		 AND thedata.gross_amount BETWEEN mm.min_price 
		 AND mm.max_price
		 AND thedata.customer_id= '".$customer."'
		 AND thedata.customer_id= '".$customer."'
		 AND mm.carrier_id IS NULL
		 AND thedata.statement_number = '".$invoice."'";
		 $query = mysql_query($sql,$con);
		?>
		<center><h5><font style="color:green;">Approved</font> Shipping: <?echo $foundCustomerName['customer_name'].", ".$invoice;?></h5></center>
