<?
	...
	{
	?>
	<center><h5><font style="color:green">Approved </font>Shipments: <?echo "<font style='color:grey'>".$foundCustomerName['customer_name']."</font>, <font style='color:grey;'>".$foundCarrierName['carrier_name']."</font>, <font style='color:grey;'>".$invoice."</font>, From: <font style='color:grey;'>".$from."</font> To:<font style='color:grey;'>".$to."</font>";?></h5></center>
