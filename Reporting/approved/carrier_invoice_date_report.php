<?
	...
	$sql = "SELECT line_item_id, 
			...
			AND thedata.weight BETWEEN mm.min_weight 
			AND mm.max_weight AND thedata.gross_amount BETWEEN mm.min_price 
			AND mm.max_price
		...
		?>
		<center><h5><font style="color:green;">Approved</font> Shipments: <?echo $foundCarrierName['carrier_name'].", ".$invoice." From:".$from." To:".$to?></h5></center>
