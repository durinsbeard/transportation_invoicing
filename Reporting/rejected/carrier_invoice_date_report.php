<?
	...
	$sql = "SELECT line_item_id, 
			...
			JOIN (SELECT min_weight, max_weight, min_price, max_price, carrier_id,customer_id FROM min_max) 
			as mm on thedata.carrier_id = mm.carrier_id
			AND thedata.weight NOT BETWEEN mm.min_weight 
			AND mm.max_weight OR thedata.gross_amount NOT BETWEEN mm.min_price 
			AND mm.max_price
		...
		?>
		<center><h5><font style="color:red;">Rejected</font> Shipments: <?echo $foundCarrierName['carrier_name'].", ".$invoice." From:".$from." To:".$to?></h5></center>
