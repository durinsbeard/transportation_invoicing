	<?	 
	if($_POST["customer"] != "" && $_POST["customer"] != ""){
	...
	{
	?>
	<center><h5><font style="color:red;">Rejected</font> Shipping: <?echo $foundCustomerName['customer_name'].", ".$foundCarrierName['carrier_name'];?></h5></center>
