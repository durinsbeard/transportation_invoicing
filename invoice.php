...
class PDF_Invoice extends FPDF
{
	...
	*/
	...
	function addCadreTVAs($terms)
	{
		...
		$this->RoundedRect($r1, $y1, ($r2 - $r1), ($y2-$y1), 2.5, 'D');
		$this->SetXY( $r1+5, $y1);
		//$this->Cell(10,4, "Payments/Credits:");
		$this->SetFont( "Arial", "B", 8);
		$this->SetXY( $r1+73, $y2 - 8 );
		$this->SetXY( $r1+10, $y1);
		$this->Cell(2,4, "Terms: Net 15,".$terms);
		$this->SetFont( "Arial", "B", 10);
		$this->SetXY( $r1+83, $y2 - 3 );
		$this->SetXY( $r1+130, $y1);
		//$this->Cell(8,4, "Balance Due: $".$total);
		//$this->SetFont( "Arial", "B", 10);
		//$this->SetXY( $r1+135, $y2 - 12 );
		//$this->Cell(10,3, $total);
	...
	function addCadreEurosFrancs($total)
	{
		...
		$this->SetFont( "Arial", "B", 8);
		$this->SetXY( $r1+22, $y1 );
		//$this->Cell(15,4, "Dollars", 0, 0, "C");
		$this->SetFont( "Arial", "", 8);
		//$this->SetXY( $r1+42, $y1 );
		//$this->Cell(15,4, "FRANCS", 0, 0, "C");
		$this->SetFont( "Arial", "B", 10);
		$this->SetXY( $r1, $y1+5 );
		$this->Cell(24,4, "Total Amount:", 0, 0, "C");
		$this->Cell(42,4,  "$".$total, 0, 0, "C");
		$this->SetXY( $r1, $y1+10 );
		$this->Cell(32,4, "Payments/Credits:", 0, 0, "C");
		$this->Cell(32,4, "$0.00", 0, 0, "C");
		$this->SetXY( $r1, $y1+15 );
		$this->Cell(24,4, "Balance Due:", 0, 0, "C");
		$this->Cell(42,4, "$".$total, 0, 0, "C");
	}
